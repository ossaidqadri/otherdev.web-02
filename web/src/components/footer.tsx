    ...
    <section className="mt-[30px] animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center gap-[6px] mb-[56px]">
        <Link
          ...
          className="h-[21px] px-1.5 bg-neutral-200 rounded-md flex items-center justify-center text-[#686868] text-[10px] font-twk font-normal leading-[14px] tracking-[-0.24px] hover:bg-neutral-300 hover:motion-scale-in-105 transition-colors motion-duration-150"
        >
          Instagram
        </Link>
        <Link
