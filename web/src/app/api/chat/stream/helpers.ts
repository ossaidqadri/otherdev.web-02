...
export function warnOnImageContentMismatch(
  ...
  if (hasImageContent === true && !hasImages) {
    console.warn('WARNING: hasImageContent flag is true but no images found in message content.')
  }

  if (hasImageContent === false && hasImages) {
    console.warn('WARNING: hasImageContent flag is false but images found in message content.')
  }
}
