...
export function formatMessagesForGroq(messages: Message[], hasImageContent: boolean | undefined): GroqMessage[] {
...
export function validateImageContent(messages: Message[], hasImageContent: boolean | undefined): void {
