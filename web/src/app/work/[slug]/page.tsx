        ...
        <div className="pt-[69px]">
          ...
          {project.downloadUrl && (
            <a
              ...
              download
              className="inline-flex bg-neutral-200 hover:bg-neutral-300 transition-colors rounded-[5px] h-[21px] px-[8px] items-center mb-[64px] gap-1.5"
            >
              <Download className="w-[10px] h-[10px] text-[#686868]" />
