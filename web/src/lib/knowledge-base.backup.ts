...
export const knowledgeBase: KnowledgeDocument[] = [
  ...
  {
    content:
      "Client testimonial for E-commerce Platform Development for Kiswa Noire: \"Other Dev understood our vision for bringing Scandinavian design principles to the digital space. The e-commerce platform they created perfectly captures our brand essence while delivering the sophisticated functionality we needed for international markets. The attention to detail in both design and technical implementation has been exceptional. Since launch, we've experienced remarkable growth in online engagement and our customers consistently praise the intuitive shopping experience. The platform's multilingual capabilities and performance have been crucial to our European expansion.\" - Kiswa Noire Team",
    metadata: {
      source: "testimonials",
  ...
  {
    content:
      'Client testimonial for Branding & website development for Wish: "Working with Other Dev was a game-changer for Wish Apparels. Their holistic approach to website development and branding delivered results far beyond our expectations. The new website\'s user-friendly design and compelling presentation directly contributed to a substantial increase in sales performance. The branding they crafted is sophisticated, memorable, and perfectly reflects our brand identity, which we have proudly adopted across all aspects of our business. We highly recommend Other Dev to any emerging brand looking for impactful digital solutions." - Talha, Founder of Wish',
    metadata: {
      source: "testimonials",
  ...
  {
    content:
      "Client testimonial for Website infrastructure creation for Narkins Builders: \"The Other Dev provided us with a website infrastructure that has significantly improved our online operations. Their team's expertise in handling complex data and integrating vital tools has streamlined our project management and enhanced our communication with clients. The website is robust, user-friendly, and has enabled us to showcase our work effectively. We appreciate The Other Dev's professionalism and commitment to delivering a high-quality solution.\" - Sarim",
    metadata: {
      source: "testimonials",
  ...
  {
    content:
      'Client testimonial for Branding & SaaS Platform Development for Finlit: "Developing Finlit from the ground up was an exciting and rewarding project for our team at Other Dev. We embraced the challenge of creating a comprehensive SaaS platform that simplifies financial literacy through thoughtful branding and intuitive design. Seeing Finlit empower individuals to take control of their financial futures is a testament to the power of well-executed digital solutions." - Kabeer, Founder of Other Dev',
    metadata: {
      source: "testimonials",
  ...
  {
    content:
      'Client testimonial for Website Development for Groovy Pakistan: "Working with Groovy Pakistan on their e-commerce development was a rewarding experience for our team at Other Dev. We focused on understanding their brand ethos and translating that into a functional and visually engaging online platform. Seeing their vision come to life digitally and knowing we played a key role in establishing their online presence is something we take pride in." - Kabeer, Founder of Other Dev',
    metadata: {
      source: "testimonials",
  ...
  {
    content:
      'Client testimonial for Branding & website development for Parcheh81: "Working with Other Dev transformed Parcheh. Their combined web and branding expertise delivered results beyond expectations. The user-friendly site achieved a dramatic boost in sales, The sophisticated branding reflects our identity perfectly and is now used everywhere. We highly recommend Other Dev to any brand needing impactful digital results." - Nasir, Founder of Parcheh',
    metadata: {
      source: "testimonials",
  ...
  {
    content:
      "Enterprise infrastucture development for Ek Qadam Aur (2023): Website Design, Website Development & Infrastructure Visit: http://ekqadamaur.kabeers.network/",
    metadata: {
      source: "projects",
  ...
  {
    content:
      "Web & Mobile App Development Process: Technical Architecture: Designing microservices architecture with Kubernetes/Docker orchestration Core Development: Implementing business logic with TypeScript/Python/Java QA Automation: Writing Jest/Cypress test suites for functionality and security",
    metadata: {
      source: "services",
  ...
  {
    content:
      "Web & Mobile App Development Benefits: Cross-Platform Compatibility. Real-Time Database Syncing. Offline-First Architecture. CI/CD Pipeline Implementation.",
    metadata: {
      source: "services",
  ...
  {
    content:
      "AR/VR Solutions Process: 3D Asset Creation: Developing optimized GLTF/USDZ models with Blender/Maya XR Development: Implementing interactions using C#/HLSL shaders Performance Optimization: Achieving 90fps VR performance through occlusion culling",
    metadata: {
      source: "services",
  ...
  {
    content:
      "AR/VR Solutions Benefits: 6DoF Tracking. Haptic Feedback Integration. Multi-User Environments. Cross-Platform Deployment.",
    metadata: {
      source: "services",
  ...
  {
    content:
      "Cloud Solutions: Full cloud transformation services including Kubernetes orchestration, serverless architectures, and multi-cloud management across AWS/Azure/GCP. Features FinOps optimization and IaC implementation. Enterprise cloud migration and optimization with infrastructure-as-code Keywords: aws, azure, cloud migration, kubernetes, serverless. Starting price: $5000",
    metadata: {
      source: "services",
  ...
  {
    content:
      "Cloud Solutions Process: Cloud Audit: Analyzing current infrastructure with CloudHealth Terraform Deployment: Implementing infrastructure-as-code Optimization: Right-sizing instances with ML-powered tools",
    metadata: {
      source: "services",
  ...
  {
    content:
      "Cloud Solutions Benefits: Auto-Scaling Clusters. Disaster Recovery. Cost Management. Zero-Downtime Migration.",
    metadata: {
      source: "services",
  ...
  {
    content:
      "Industrial Simulations Process: Model Preparation: CAD cleanup and mesh generation Solver Configuration: Setting up parallel computing parameters Post-Processing: Generating CFD/FEA reports with ParaView",
    metadata: {
      source: "services",
  ...
  {
    content:
      "Industrial Simulations Benefits: GPU-Accelerated Solvers. DOE Optimization. Real-Time Visualization. ISO 26262 Compliance.",
    metadata: {
      source: "services",
  ...
  {
    content:
      "OtherDev is a LocalBusiness based in Karachi, Pakistan. Contact: +92 315 6893331 | hello@otherdev.com. Website: https://www.otherdev.com. Service areas: US, Canada, UK, Australia, Pakistan, Germany. Languages: English, German, Urdu.",
    metadata: {
      source: "company",
  ...
  {
    content:
      "OtherDev Founders - Kabeer Jaffri and Ossaid Qadri: OtherDev was founded in 2021 by Kabeer Jaffri and Ossaid Qadri. The two founders met while studying at Habib Public School in Karachi. Together, they built OtherDev into a full-service web development and design studio that serves clients across multiple industries including fashion, design, e-commerce, real estate, and enterprise solutions. Their vision is to create digital platforms for pioneering creatives, bringing innovative ideas to life through thoughtful design and cutting-edge technology.",
    metadata: {
      source: "company",
