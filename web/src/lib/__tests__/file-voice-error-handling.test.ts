...
describe('File & Voice Error Handling', () => {
  describe('File Size Validation', () => {
    it('should reject files exceeding 50MB total per message', () => {
      ...
      const oversizeFile = new File([new ArrayBuffer(maxSize + 1)], 'large.pdf', {
  ...
  describe('File Type Validation', () => {
    ...
    it('should accept valid document types', () => {
      const validDocTypes = ['application/pdf', 'text/plain', 'text/markdown', 'application/json']
    ...
    it('should reject unsupported file types', () => {
      const _unsupportedTypes = ['application/exe', 'application/x-msdownload']
