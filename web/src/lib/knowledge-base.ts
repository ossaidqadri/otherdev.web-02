...
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: narkins-2024)`,
  ...
  {
    content: `Overview. The 2024 Narkins Builders engagement focused on creating website infrastructure to present the construction portfolio and services with reliable UX and inquiry pathways. This project is distinct from the later 2025 SEO implementation effort.`,
    metadata: {
      source: "projects",
  ...
  {
    content: `Results. Delivered a stable web foundation for client communication and portfolio presentation. This infrastructure engagement established the baseline for subsequent optimization work.`,
    metadata: {
      source: "projects",
...
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: olly-shinder-2025)`,
  ...
  {
    content: `Overview. Olly Shinder is a menswear designer from London associated with Fashion East and Dover Street Market incubators. The project focused on a minimal grid-based platform to unify collections and commerce content in one coherent experience.`,
    metadata: {
      source: "projects",
  ...
  {
    content: `Results. Delivered a unified digital presence that supports both editorial collection storytelling and e-commerce navigation with a minimal design system.`,
    metadata: {
      source: "projects",
...
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: cultured-legacy-2024)`,
  ...
  {
    content: `Overview. The Cultured Legacy project delivered a sophisticated and accessible e-commerce experience designed to reflect refined brand heritage while guiding customers through product exploration and purchase decisions.`,
    metadata: {
      source: "projects",
...
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: ntl-2024)`,
  ...
  {
    content: `Overview. NTL Exchange required an integrated digital ecosystem including brand identity, mobile app development, responsive web presence, and enterprise-grade infrastructure to support secure and efficient exchange workflows.`,
    metadata: {
      source: "projects",
  ...
  {
    content: `Results. Delivered a unified cross-platform foundation connecting branding, web, mobile, and infrastructure layers for consistent service delivery and operational reliability.`,
    metadata: {
      source: "projects",
...
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: blvd-pakistan-2025)`,
  ...
  {
    content: `Results. Delivered a modern digital brand foundation and e-commerce presentation supporting both direct presence and partner-facing brand credibility.`,
    metadata: {
      source: "projects",
...
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: ads-portfolio)`,
  ...
  {
    content: `Overview. This portfolio aggregates high-impact digital ad creatives built for conversion and brand awareness across multiple campaign contexts and visual styles.`,
    metadata: {
      source: "projects",
  ...
  {
    content: `Results. Provides reusable creative references and proof of execution quality for social and performance marketing campaigns.`,
    metadata: {
      source: "projects",
...
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: adinahousehold)`,
  ...
  {
    content: `Overview. Adina Household required an elegant storefront for premium ceramic tableware and dinnerware collections, with presentation quality aligned to craftsmanship and material detail.`,
    metadata: {
      source: "projects",
  ...
  {
    content: `Results. Delivered a premium visual-commerce experience that supports product storytelling and category browsing for household ceramic collections.`,
    metadata: {
      source: "projects",
...
TEAM APPROACH: Combined technical excellence with data-driven growth strategy`,
  ...
  {
    content: `Who founded Other Dev? Other Dev was founded in 2021 by two entrepreneurs: Kabeer Jaffri and Ossaid Qadri. They met at Habib Public School in Karachi and later established the agency to deliver premium web development and digital marketing services. Kabeer serves as Founder and Technical Lead, bringing, as of March 2026, 8 years of full-stack development experience. Ossaid serves as Co-Founder, Frontend Architect, and Growth Lead, specializing in Next.js, React, and growth marketing campaigns.`,
    metadata: {
      source: "about",
